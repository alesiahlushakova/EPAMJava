...
<fmt:bundle basename="page_content">
    ...
    <fmt:message key="edit.photo" var="photo"/>
    ...
    <fmt:message key="menu.edit" var="edit_submit"/>
...
<div class="reg_form">
    <form id="reg" name="EditingForm" method="POST" action="${pageContext.request.contextPath}/controller" enctype="multipart/form-data">
        ...
        <p>
            <span>${pageScope.photo}</span>
            <input type="file" name="photo" size="50">
        </p>
        <input class="reg_submit" id="submit" type="submit" value="${pageScope.edit_submit}" />
