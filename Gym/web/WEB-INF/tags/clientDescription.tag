        ...
        <c:forEach var="client" items="${clients}">
            ...
            <tr>
                ...
                <td>
                    <c:choose>
                        <c:when test="${role.equals('COACH')}">
                            <a href="controller?command=special_show_client_program&client_id=${client.id}">${pageScope.describe}
                                <i class="fa fa-info-circle" aria-hidden="true"></i></a>
                        </c:when>
                        <c:otherwise>
                            <a href="controller?command=special_show_client_subscriptions&client_id=${client.id}">${pageScope.describe}
                                <i class="fa fa-info-circle" aria-hidden="true"></i></a>
                        </c:otherwise>
                    </c:choose>
                </td>
