...
import by.training.gym.command.RegisterCommand;
...
/**
 * command that registers coach.
 * @author Alesyahlushakova
 */
public class RegisterCoachCommand implements Command {
    ...
    public CurrentJsp execute(HttpServletRequest request) {
        ...
        try {
            ...
            if (isLoginNotUnique) {
                return new CurrentJsp(CurrentJsp.REGISTER_COACH_PAGE_PATH,
            ...
            boolean isOperationSuccessful = userService.registerCoach(login, password,
                    firstName, lastName, telephone);
