...
/**
        ...
        */
public class FinishProgramCreationCommand implements Command {

    private static final Logger LOGGER = LogManager.getLogger(FinishProgramCreationCommand.class);

    /**
     * overrides command to save training program.
     *
    ...
    public CurrentJsp execute(HttpServletRequest request) {
        ...
        try {
            ...
            int trainingProgramId = trainingProgramService.saveProgram(trainingProgram);
            ...
            if (!isResultSuccessful) {
                return new CurrentJsp(EDIT_PROGRAM_PAGE_PATH, false, TRAINING_PROGRAM_NOT_SAVED_MESSAGE_KEY);
            }
